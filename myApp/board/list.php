<?
	...
	$query = sprintf("SELECT * FROM $tablename ORDER BY NUMBER DESC LIMIT %d, %d",  mysql_real_escape_string($offset,$connect), mysql_real_escape_string($list_num,$connect) ); // SQL 쿼리문
...
<table border=1 cellspacing=0 width=680 bordercolordark=white bordercolorlight=#999999>
	...
	<tr>
		<td width=100% colspan=5><p align=center><a href='write.php'>[글쓰기]</a></p>	</td>
	</tr>
</table>
</body>
</html>