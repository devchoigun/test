<?php
	...
	$query = "SELECT COUNT(m_id) AS cnt FROM member";
	...
	$query = sprintf("SELECT m_id, m_name, m_pass, m_email, DATE_FORMAT(regdate, '%%Y/%%m/%%d') as regdate FROM member ORDER BY regdate LIMIT %u, %u", escape_data($offset), escape_data($list_num) );
			...
			<div class="grid_16">
				<div class="box">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="display">
						...
						<tfoot>
							<tr>
								<th colspan="6" align="right"><? echo $page ?> page of <? echo $total_page ?> pages / total count [<? echo $total_no ?>] </th>
							</tr>
						</tfoot>
						<tbody>
							<?
